...
/// iterations it took for 'c' to leave the circle of radius 2 centred on the 
...
///
/// Specificially, 's' should have the form <left><sep><right>, where <sep> is
...
/// ASCII character.
///
/// If 's' has a proper form, return 'Some<(x, y)>'. If it doesn't parse
